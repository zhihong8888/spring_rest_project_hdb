...
- Spring boot (Builds stand alone, production ready Java Spring Applications. Automactically detects Spring MVC controller and starts up an embedded Apache Tomcat 7 insance into the Java web application)
